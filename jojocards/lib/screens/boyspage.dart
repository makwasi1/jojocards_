              ...
              child: Container(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromPins(
                      Pin(size: 43.0, middle: 0.2338),
                      Pin(size: 65.0, middle: 0.2907),
                      child: Text(
                        '',
                        style: TextStyle(
                          fontFamily: 'Papyrus',
...
class Boys {
  static List<String> getBoysDares() {
    return [
      ...
      "Have you ever been caught doing something you aren’t supposedto be doing. \n Or \n Wear the bra of the girl on your right.",
      "Who is your latest crush. \n Or \n Sit on the lap of a guy for 10mins(players choose who).",
...
const String _svg_h6xymu =
    '<svg viewBox="74.6 238.9 266.2 447.3" ><path transform="matrix(0.0, -1.0, 1.0, 0.0, 74.62, 686.17)" d="M 0 266.1939392089844 L 447.2748107910156 266.1939392089844 L 447.2748107910156 0 L 0 0 L 0 266.1939392089844 Z" fill="#1f2059" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
