...
class Boys {
  static List<String> getBoysDares() {
    return [
     ...
     "What is the best thing you’ve ever done for your parents? \n Or \n Write an appreciation letter to your parents and read it out. ",
     ...
     "Have you ever faked a sickness to stay home and miss school? \n Or \n Attempt to do 10push ups.",
     ...
     "What is the grossest thing you have done today? \n Or \n Sniff the inside of someone’s shoe(players choose who).",
...
const String _svg_h6xymu =
    '<svg viewBox="74.6 238.9 266.2 447.3" ><path transform="matrix(0.0, -1.0, 1.0, 0.0, 74.62, 686.17)" d="M 0 266.1939392089844 L 447.2748107910156 266.1939392089844 L 447.2748107910156 0 L 0 0 L 0 266.1939392089844 Z" fill="#ffff00" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
