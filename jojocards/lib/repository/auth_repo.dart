...
class AuthClass {
  ...
  Future<void> googleSignIn(BuildContext context) async {
    try {
      ...
      final snackBar = SnackBar(content: Text("Google Sign in Failed Try again."));
      ScaffoldMessenger.of(context).showSnackBar(snackBar);
    }
  }
  ...
  void storeTokenAndData(UserCredential userCredential) async {
    ...
    await storage.write(key: "usercredetial", value: userCredential.toString());
  }
  ...
  Future<void> verifyPhoneNumber(
    ...
    PhoneVerificationFailed verificationFailed =
      ...
      showSnackBar(context, "Verification Failed. Please ensure you entered an active number");
    };

    PhoneCodeSent codeSent =
        (String verificationID, [int forceResendingToken]) {
      showSnackBar(context, "Verification Code sent to phone number");
